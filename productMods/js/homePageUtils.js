...
$(document).ready(function(){
 ...
 function buildAssociateMembers() {
        var memNbr = associateMembers.length;
        var memhtml = "<ul>";
        ...
        if ( memNbr == 0 ) {
            memhtml = "<ul style='list-style:none'><p><li style='padding-top:0.3em'>"
                ...
                if(!memindexFound) {
                        //if this memindex hasn't already been employed then utilize it
                         memhtml += "<li><a href='" + urlsBase + "/individual?uri="
                     + associateMembers[memindex].uri + "'>"
                     + associateMembers[memindex].name + "</a></li>";
            ...
            for ( var i=0;i<memNbr;i++) {
                memhtml += "<li><a href='" + urlsBase + "/individual?uri="
                        + associateMembers[i].uri + "'>"
                        + associateMembers[i].name + "</a></li>";
            }
	}
	if ( memNbr > 0 ) {
	...
	$('div#associate-members').html(memhtml);
    }
