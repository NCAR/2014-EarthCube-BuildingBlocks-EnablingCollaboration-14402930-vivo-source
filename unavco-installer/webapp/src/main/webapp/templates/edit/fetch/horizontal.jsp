...
<%if (request.getAttribute("horizontalJspAddButtonUrl") != null) {%>
  <td>
    <form action="<%=request.getAttribute("horizontalJspAddButtonUrl")%>" method="get"><input type="submit" class="btn btn-success form-button" value="<%=request.getAttribute("horizontalJspAddButtonText")%>"/>
...
<table class="table table-striped" border="0" cellpadding="2" cellspacing="0" width = "100%">
