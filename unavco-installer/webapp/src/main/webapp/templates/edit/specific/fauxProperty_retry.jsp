...
<tr class="editformcell">
    <td valign="top" colspan="2">
        ...
        <input type="text" class="form-control fullWidthInput" name="Base property" value="<form:value name="BaseLabel"/>" disabled="disabled" /></br>
        <i>a specification of this property</i></br>
    </td>
    <td valign="top" colspan="2">
	    <b>Property group</b><br/>
	    <select class="form-control" name="GroupURI"><form:option name="GroupURI"/></select><br/>
...
<tr class="editformcell">
    <td style="vertical-align:top;" valign="top" colspan="2">
        ...
        <input type="text" class="form-control fullWidthInput" name="DisplayName" value="<form:value name="DisplayName"/>" maxlength="80" />
...
<tr class="editformcell">
    <td valign="top" colspan="2">
        <b>Domain class</b><br />
        <select class="form-control" name="DomainURI"><form:option name="DomainURI"/></select>
    </td>
    <td valign="top" colspan="2">
        <b>Range class*</b><br />
        <select class="form-control" name="RangeURI" ><form:option name="RangeURI"/></select>
...
<tr class="editformcell">
	<td valign="top" colspan="5">
	    ...
	    <textarea class="form-control matchingInput" name="PublicDescription"><form:value name="PublicDescription"/></textarea>
...
<tr class="editformcell">
    <td valign="top" colspan="2">
        ...
        <select class="form-control" name="HiddenFromDisplayBelowRoleLevelUsingRoleUri">
            <form:option name="HiddenFromDisplayBelowRoleLevelUsingRoleUri"/>
        </select>
    </td>
    <td valign="top" colspan="1">
        <b>Update level</b><br/>
        <select class="form-control" name="ProhibitedFromUpdateBelowRoleLevelUsingRoleUri">
            <form:option name="ProhibitedFromUpdateBelowRoleLevelUsingRoleUri"/>
        </select>
    </td>
    <td valign="top" colspan="2">
        <b>Publish level</b><br />
        <select class="form-control" name="HiddenFromPublishBelowRoleLevelUsingRoleUri">
...
<tr class="editformcell">
    <td valign="top" colspan="1">
        ...
        <input type="text" class="form-control shortInput" name="DisplayTier" value="<form:value name="DisplayTier"/>" /><br/>
	...
	<td valign="top" colspan="2">
		...
		<input type="text" class="form-control shortInput" name="DisplayLimit" value="<form:value name="DisplayLimit"/>"/>
    ...
    <td valign="top" colspan="2">
        ...
        <c:choose>
            <c:when test="${collateBySubclass}">
              <div class="checkbox">
<label>  <input name="CollateBySubclass" type="checkbox" value="TRUE" checked="checked"/>collate by subclass</label></div>
            </c:when>
            <c:otherwise>
                <div class="checkbox"><label><input name="CollateBySubclass" type="checkbox" value="TRUE"/>collate by subclass</label></div>
            </c:otherwise>
        </c:choose>
    </td>
</tr>
    	...
    	Select related individuals from existing choices?<br/>
       	<c:choose>
            <c:when test="${selectFromExisting}">
    	       	<div class="checkbox"><label><input name="SelectFromExisting" type="checkbox" value="TRUE" checked="checked"/>provide selection</label></div>
            </c:when>
            <c:otherwise>
               	<div class="checkbox"><label><input name="SelectFromExisting" type="checkbox" value="TRUE"/>provide selection</label></div>
            </c:otherwise>
        </c:choose>
    </td>
    <td valign="top" colspan="1">
    	Allow creating new related individuals?<br/>
       	<c:choose>
            <c:when test="${offerCreateNewOption}">
    	       	<div class="checkbox"><label><input name="OfferCreateNewOption" type="checkbox" value="TRUE" checked="checked"/>offer create option</label></div>
            </c:when>
            <c:otherwise>
               	<div class="checkbox"><label><input name="OfferCreateNewOption" type="checkbox" value="TRUE"/>offer create option</label></div>
            </c:otherwise>
        </c:choose>
    </td>
</tr>
...
<tr class="editformcell">
    <td valign="top" colspan="5">
        ...
        <input type="text" class="form-control fullWidthInput" name="CustomEntryForm" value="<form:value name="CustomEntryForm"/>" />
...
<tr class="editformcell">
        ...
        <input type="text" class="form-control fullWidthInput" name="CustomListView" value="<form:value name="CustomListView"/>" />
