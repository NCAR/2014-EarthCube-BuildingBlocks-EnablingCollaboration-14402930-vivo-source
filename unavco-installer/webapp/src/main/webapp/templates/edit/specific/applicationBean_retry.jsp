...
<div class="form-group">
    ...
    <input class="form-control" type="text" name="ApplicationName" value="<form:value name="ApplicationName"/>" ${longField} maxlength="50" />
...
<!-- <tr class="editformcell">
    <td valign="top" colspan="2">
        ...
        <div class="form-group">
            <label for="ContactMail">Contact email address <span class="note">contact form submissions will be sent to this address</span></label>
            <input class="form-control" type="text" name="ContactMail" value="<form:value name="ContactMail"/>" ${longField} maxlength="255" size="30" />
        ...
        <div class="form-group">
            <label for="ThemeDir" class="display-inline">Theme</label>
            <select class="form-control" id="ThemeDir" name="ThemeDir">
                <form:option name="ThemeDir" />
            </select>
        </div>
        <div class="form-group">
            <label for="CopyrightAnchor">Copyright text<span class="note"> used in footer (e.g., name of your institution)</span></label>
            <input class="form-control" type="text" name="CopyrightAnchor" value="<form:value name="CopyrightAnchor"/>" ${longField} maxlength="120" size="40" />
        ...
        <div class="form-group">
            <label for="CopyrightURL">Copyright URL<span class="note"> copyright text links to this URL</span></label>
            <input class="form-control" type="text" name="CopyrightURL" value="<form:value name="CopyrightURL"/>" ${longField} maxlength="120" size="30" />
