...
<tr valign="bottom" align="center">
	<td>
        <form action="showDataPropertyHierarchy" method="get">
            <input type="submit" class="btn btn-success form-button" value="Data Property Hierarchy"/>
        </form>
		<form action="listDatatypeProperties" method="get">
			<input type="submit" class="btn btn-success form-button" value="All Data Properties"/>
		</form>
	...
	<td valign="bottom" align="center">
		<form action="editForm" method="get">
			...
			<input type="submit" class="btn btn-success form-button" value="Edit this Data Property"/>
		</form>
	</td>
	<td valign="bottom">
		<form action="editForm" method="get">
			<input type="hidden" name="controller" value="Dataprop"/>
			<input type="submit" class="btn btn-success form-button" value="Add New Data Property"/>
		</form>
		<form action="editForm" method="get">
