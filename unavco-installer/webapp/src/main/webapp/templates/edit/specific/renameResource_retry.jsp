...
<tr class="editformcell">
    <td>
        ...
        <label for="newURI"><b>New URI</b>&nbsp;<span class="note"> (must begin with http:// or https://)</span></label>
        <br/>
        <span class="warning"><strong>${epo.attributeMap['errorMsg']}</strong></span>
        <input class="form-control" type="text" size="95%" name="newURI" value='<%=request.getParameter("oldURI")%>'/>
      </div>
    </td>
</tr>
