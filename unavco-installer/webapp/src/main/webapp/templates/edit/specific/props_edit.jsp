...
<tr valign="bottom" align="center">
    <td>
        <form action="showObjectPropertyHierarchy" method="get">
            ...
            <input type="submit" class="btn btn-success form-button" value="Root Properties"/>
        </form>
        <form action="listPropertyWebapps" method="get">
            <input type="submit" class="btn btn-success form-button" value="See All Properties"/>
        </form>
        <form action="showObjectPropertyHierarchy" method="get">
	    	<input type="hidden" name="propertyUri" value="${property.URI}"/>
            <input type="submit" class="btn btn-success form-button" value="Show Hierarchy below This Property"/>
        </form>
        <form action="listVClassWebapps" method="get">
			...
			<input type="submit" class="btn btn-success form-button" value="Show Classes With a Restriction on This Property"/>
		</form>
        <form action="listObjectPropertyStatements" method="get">
        	...
        	<input type="submit" class="btn btn-success form-button" value="Show Examples of Statements Using This Property"/>
        </form>
    </td>
    <td valign="bottom" align="center">
        <form action="editForm" method="get">
            <input name="uri" type = "hidden" value="${property.URI}" />
            <input type="submit" class="btn btn-success form-button" value="Edit Property Record"/>
    ...
    <td valign="bottom">
	    ...
	    <input type="hidden" name="controller" value="Property"/>
            <input type="submit" class="btn btn-success form-button" value="Add New Child Property"/>
        </form>
        <form action="editForm" method="get">
            <input type="submit" class="btn btn-success form-button" value="Add New Property"/>
	    <input type="hidden" name="controller" value="Property"/>
        </form>
            <form action="editForm" method="get">
            <input type="submit" class="btn btn-success form-button" value="Change URI"/>
        ...
        <form action="editForm" method="get">
            <input type="submit" class="btn btn-success form-button" value="Move Statements to Different Property"/>
            <input type="hidden" name="propertyURI" value="${property.URI}"/>
        ...
        <c:if test="${!empty property.URIInverse}">
	        <form action="propertyEdit" method="get">
	            <input type="submit" class="btn btn-success form-button" value="Go to Inverse Property"/>
...
<tr valign="bottom" align="center">
	...
	<form action="editForm" method="get">
	  ...
	  <input type="submit" class="btn btn-success form-button" value="Create New Faux Property"/>
	</form>
	</td>
</tr>
	...
	<td colspan="2" valign="bottom" align="left">
	   <c:if test="${!empty superproperties}">
		<form action="props2PropsOp" method="post">
			...
			<input type="submit" class="btn btn-success form-button" value="Remove Checked Superproperty Links"/>
		</form>
	    </c:if>
	</td>
	<td>
		<form action="editForm" method="get">
			...
			<input type="submit" class="btn btn-success form-button" value="New Link to Superproperty"/>
		</form>
	</td>
</tr>
<tr><td colspan="3"><hr/></td></tr>
...
<tr valign="bottom" align="center">
	<td colspan="2" valign="bottom" align="left">
		...
		<form action="props2PropsOp" method="post">
			...
			<input type="submit" class="btn btn-success form-button" value="Remove Checked Subproperty Links"/>
            <input type="hidden" name="_epoKey" value="${epoKey}"/>
			<input type="hidden" name="operation" value="remove"/>
		</form>
             </c:if>
	...
	<td valign="bottom">
		<form action="editForm" method="get">
			...
			<input type="submit" class="btn btn-success form-button" value="New Link to Subproperty"/>
		</form>
		<form action="editForm" method="get">
			<input type="hidden" name="controller" value="Property"/>
			<input type="hidden" name="parentId" value="${property.URI}" />
			<input type="submit" class="btn btn-success form-button" value="Add New Subproperty of This Property"/>
		</form>
	</td>
</tr>
...
<tr valign="bottom" align="center">
    <td colspan="2" valign="bottom" align="left">
        ...
        <form action="props2PropsOp" method="post">
            ...
            <input type="hidden" name="SuperpropertyURI" value="${property.URI}"/>
            <input type="submit" class="btn btn-success form-button" value="Remove Checked Equivalent Property Links"/>
            <input type="hidden" name="_epoKey" value="${epoKey}"/>
            <input type="hidden" name="operation" value="remove"/>
    ...
    <td valign="bottom">
        <form action="editForm" method="get">
            ...
            <input type="hidden" name="opMode" value="equivalentProperty"/>
            <input type="hidden" name="propertyType" value="object"/>
            <input type="submit" class="btn btn-success form-button" value="New Link to Equivalent Property"/>
        </form>
    </td>
</tr>
