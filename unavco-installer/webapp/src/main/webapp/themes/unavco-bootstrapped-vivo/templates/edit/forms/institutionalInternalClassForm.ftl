...
<section role="region">
    <form method="POST" action="${formUrl}" class="customForm">
        ...
        <section id="existingLocalClass" role="region">
            ...
            <select class="form-control" id="existingLocalClasses" name="existingLocalClasses" role="combobox"<strong></strong>>
        ...
        <section id="createNewLocalClass" role="region">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="localClassName" name="localClassName" value="" role="input" />
            ...
            <div class="form-group">
                ...
                <select class="form-control">id="existingLocalNamespaces" name="existingLocalNamespaces" role="combobox">
        ...
        <#if ontologiesExist = true>
            <input type="submit" name="submit-internalClass" value="${submitAction}" class="btn btn-success submit" /> <a class="btn btn-warning cancel" href="${cancelUrl}" title="${i18n().cancel_title}">${i18n().cancel_link}</a>
        </#if>
    </form>
</section>
