...
<#macro dateTime precision="full" required=specificity>
    ...
    <fieldset class="dateTime">
        ...
        <#if precLevel gte 1>
            ...
            <input class="form-control text-field" name="${fieldName}-year" id="${fieldName}-year" type="text" value="${year!}" size="4" maxlength="4" <#if reqLevel gte 1>required </#if>/>
        </#if>

        <#if precLevel gte 2>
            <label for="${fieldName}-month">Month<#if reqLevel gte 2> <span class="requiredHint">*</span></#if></label>
            <select class="form-control" name="${fieldName}-month" id="${fieldName}-month" <#if reqLevel gte 2>required </#if>>
        ...
        <#if precLevel gte 3>
            ...
            <select class="form-control" name="${fieldName}-day" id="${fieldName}-day" <#if reqLevel gte 3>required </#if>>
        ...
        <#if precLevel gte 4>
            ...
            <select class="form-control" name="${fieldName}-hour" id="${fieldName}-hour" <#if reqLevel gte 3>required </#if>>
        ...
        <#if precLevel gte 5>
            ...
            <select class="form-control" name="${fieldName}-minute" id="${fieldName}-minute" <#if reqLevel gte 5>required </#if>>
        ...
        <#if precLevel gte 6>
            ...
            <select class="form-control" name="${fieldName}-second" id="${fieldName}-second" <#if reqLevel gte 6>required </#if>>
