...
<section id="grantHasContributorSection" role="region">
    ...
    <p >
        ...
        <label for="person">${i18n().person_capitalized}: ${i18n().last_name}  ${requiredHint}</label>
            <input class="form-control acSelector" size="50"  type="text" acGroupName="person" id="person" name="personLabel" value="${personLabelValue}" >
            ...
            <input class="form-control" size="30"  type="text" id="firstName" name="firstName" value="${firstNameValue}" >
    ...
    <select class="form-control" name="roleType" style="margin-top:-2px" >
    ...
    <p class="submit">
         <input class="btn btn-success" type="submit" id="submit" value="${submitButtonText}"/>
         <a class="btn btn-warning cancel" href="${cancelUrl}" title="${i18n().cancel_title}">${i18n().cancel_link}</a>
     </p>
