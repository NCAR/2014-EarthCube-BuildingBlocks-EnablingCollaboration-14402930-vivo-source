...
<section id="externalAuthMatchId">
    <div id="associateProfileBackgroundOne">
        <div class="form-group" id="alignExternalAuthId">
        <#if showAssociation??>
             <label for="externalAuthId">${strings.auth_matching_id_label}</label>
            <input class="form-control" type="text" name="externalAuthId" value="${externalAuthId}" id="externalAuthId" role="input "/>
            <span id="externalAuthIdInUse" >${strings.auth_id_in_use}</span>
            <p class="explanatoryText">${strings.auth_id_explanation}</p>
        <#else>
            <label class="form-control" for="externalAuthId">${strings.auth_id_label}</label>
    ...
    <section id="associationOptions">
        <div id="associateProfileBackgroundThree">
            <p>
                ...
                <input class="form-control" type="text" id="associateProfileName" name="associateProfileName" class="acSelector" size="35">
            </p>
        </div>
