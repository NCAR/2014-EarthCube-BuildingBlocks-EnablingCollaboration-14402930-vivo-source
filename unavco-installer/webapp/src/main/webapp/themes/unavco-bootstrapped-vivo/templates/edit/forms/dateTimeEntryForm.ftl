...
<fieldset class="dateTime">
  ...
  <#if datatype?contains("#date") || datatype?contains("Year") >
    ...
    <input class="form-control text-field" name="dateTimeField-year" id="dateTimeField-year" type="text" value="" size="4" maxlength="4" />
  </#if>
  <#if datatype?contains("#date") || datatype?contains("Month") >
    <label for="dateTimeField-month">Month</label>
    <select class="form-control" name="dateTimeField-month" id="dateTimeField-month" >
  ...
  <#if datatype?contains("#date") >
    ...
    <select class="form-control" name="dateTimeField-day" id="dateTimeField-day" >
  ...
  <#if datatype?contains("#dateTime") || datatype?contains("#time") >
    ...
    <select class="form-control" name="dateTimeField-hour" id="dateTimeField-hour" >
    ...
    <select class="form-control" name="dateTimeField-minute" id="dateTimeField-minute" >
    ...
    <select class="form-control" name="dateTimeField-second" id="dateTimeField-second" >
