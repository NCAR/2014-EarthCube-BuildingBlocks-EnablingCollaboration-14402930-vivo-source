...
<form method="POST" action="${formUrls.add}" id="add-account" class="customForm" role="Add account">
    <h3><span>${strings.user_accounts_link} | </span><input type="submit" class="btn btn-success submit add-account" value="${strings.add_new_account}" /></h3>
</form>
...
<section id="filter-roles">
    <form method="POST" action="${formUrls.list}" class="customForm" role="filter by roles">
        <select class="form-control" name="roleFilterUri" id="roleFilterUri">
...
<section id="search-accounts">
    <form method="POST" action="${formUrls.list}" class="form-inline customForm" role="search accounts">
        <input class="form-control" type="text" name="searchTerm" />
        <input class="btn btn-default submit" type="submit" value="${strings.search_accounts_button}"/>
        <!--
