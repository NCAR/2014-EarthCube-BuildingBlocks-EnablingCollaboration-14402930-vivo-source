...
<#macro accountsNav accountsCount=counts>
  ...
  <section class="accounts">
      ...
      <input type="submit" name="delete-account" class="btn btn-danger delete-account delete" value="${i18n().delete_button}" onClick="changeAction(this.form, '${formUrls.delete}')" />
      <!--
      ...
      -->
          ...
          <div class="col-sm-10 text-right col-xs-8">| ${total} ${i18n().accounts} |
