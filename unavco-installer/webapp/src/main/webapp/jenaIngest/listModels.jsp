...
function init(){
    ...
    <td>
     <form name="showContentModelsForm" action="ingest" method="get">
        ...
        <input class="btn btn-default" type="submit" name="submit" value="Main Store Models"/>
    </form>
    </td>
    <td>
    <form name="showConfigurationModelsForm" action="ingest" method="get">
        <input type="hidden" name="action" value="configModels"/>
        <input class="btn btn-default" type="submit" name="submit" value="Configuration Models"/>
    </form>
    </td>
    </tr>
    </table>
    <form name="ingesting" action="ingest" method="get">
        ...
        <input class="btn btn-default" type="submit" name="submit" value="Create Model"/>
    </form>
      ...
      <c:forEach var="modelName" items="${modelNames}">
          <li style="padding-bottom:2em;padding-top:2em;"> ${modelName}
            ...
            <form action="ingest" method="get">
                ...
                <input type="hidden" name="modelType" value="${modelType}"/>
                <input class="btn btn-default" type="submit" name="submit" value="load RDF data"/>
            </form>
            </td>
            <td>
            ...
            <form action="ingest" method="post">
                ...
                <input type="hidden" name="modelName" value="${modelName}"/>
                <input type="hidden" name="modelType" value="${modelType}"/>
                <input class="btn btn-default" type="submit" name="submit" value="clear statements"/>
            </form>
            </td>
            <td>
            <form action="ingest" method="post">
            ...
            <form action="ingest" method="post">
                ...
                <input type="hidden" name="modelName" value="${modelName}"/>
                <input type="hidden" name="modelType" value="${modelType}"/>
                <input class="btn btn-default" type="submit" name="submit" value="attach snapshot to ontology"/>
            </form>
            </td>
            <td>
            <form action="ingest" method="post">
                ...
                <input type="hidden" name="modelName" value="${modelName}"/>
                <input type="hidden" name="modelType" value="${modelType}"/>
                <input class="btn btn-default" type="submit" name="submit" value="detach snapshot from ontology"/>
            </form>
            </td>
            <td>
			<form action="ingest" method="get">
			    ...
			    <input type="hidden" name="modelName" value="${modelName}" />
				<input type="hidden" name="modelType" value="${modelType}"/>
				<input class="btn btn-default" type="submit" name="submit" value="generate permanent URIs" /></form>
			</td>
            <td>&nbsp;</td>
            </tr>
            </table>
