...
<form class="form-horizontal" id="takeuri" action="ingest" method="get">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="uri1">Old namespace:</label>
        <div class="col-sm-9">
            <input class="form-control" id="uri1" type="text" size="52" name="oldNamespace" value="${oldNamespace}" />
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-3" for="uri2">New namespace:</label>
        <div class="col-sm-9">
            <input class="form-control" id="uri2" type="text" size="52" name="newNamespace" value="${newNamespace}" />
        </div>
    </div>

    <input class="btn btn-success" id="submit" type="submit" name="submit" value="Change namespace" />
</form>
