...
<div class="form-group">
  <select class="form-control" name="savedQuery">
...
<div class="form-group">
    <textarea class="form-control" rows="25" name="sparqlQueryStr" class="maxWidth"><c:choose>
...
%>
	...
	<div class="checkbox">
  <label><input type="checkbox" name="sourceModelName"
...
<input class="btn btn-success" id="submit" type="submit" value="Execute CONSTRUCT" />
